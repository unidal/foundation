...
public class EventModel extends BaseEntity<EventModel> {
   ...
   public EventModel addSuccess(Integer success) {
      m_successes.add(success);
      return this;
   }

   public EventModel addValue(String value) {
      m_values.add(value);
      return this;
   }
   ...
   @Override
   public void mergeAttributes(EventModel other) {
