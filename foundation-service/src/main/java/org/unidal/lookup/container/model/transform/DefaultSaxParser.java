   ...
   public void endElement(String uri, String localName, String qName) throws SAXException {
      if (uri == null || uri.length() == 0) {
         ...
         if (currentObj instanceof ComponentModel) {
            ...
            if (m_text.length() != 0) {
               ((ComponentModel) currentObj).getDynamicElements().add(new Any().setValue(getText()));
            }
         } else if (currentObj instanceof ConfigurationModel) {
            if (m_text.length() != 0) {
               ((ConfigurationModel) currentObj).getDynamicElements().add(new Any().setValue(getText()));
            }
         } else if (currentObj instanceof RequirementModel) {
            if (m_text.length() != 0) {
               ((RequirementModel) currentObj).getDynamicElements().add(new Any().setValue(getText()));
            }
         }
      }
